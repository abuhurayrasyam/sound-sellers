        ...
        <div className=" max-w-11/12 mx-auto">
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <button className="px-6 py-3 bg-[#A67C52] rounded-full text-white font-medium transition">
                Shop Now
              </button>
              <button className="px-6 py-3 border border-[#A67C52] rounded-full text-white font-medium hover:bg-[#A67C52] hover:text-black transition">
                Find Lessons
              </button>
            </div>
