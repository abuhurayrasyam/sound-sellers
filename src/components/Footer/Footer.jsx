...
const Footer = () => {
  return (
    <footer className="bg-[#1F1F1F] text-[#FCFCFC] py-12">
          ...
          <div className="max-w-11/12 mx-auto">
            <div className="flex flex-col lg:flex-row justify-between gap-12">
              <div className="flex-1 text-center lg:text-left">
                ...
                <p className="text-sm text-[#A8A29E] leading-relaxed max-w-xs mx-auto lg:mx-0">
                  The premier marketplace for musical instruments and equipment.
                  Connect with musicians, find your perfect gear, and grow your
                  musical journey.
                </p>

                <div className="flex justify-center lg:justify-start space-x-4 mt-4 text-[#A8A29E]">
              ...
              <div className="flex-[2] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 text-center sm:text-left">
                <div>
                  <h4 className="text-[#FFFFFF] font-semibold mb-3">Marketplace</h4>
                ...
                <div>
                  <h4 className="text-[#FFFFFF] font-semibold mb-3">Support</h4>
                  <ul className="space-y-2 text-sm text-[#A8A29E]">
                ...
                <div>
                  <h4 className="text-[#FFFFFF] font-semibold mb-3">Stay Updated</h4>
                  <p className="text-sm text-[#A8A29E] mb-3">
                    Get the latest deals and music news delivered to your inbox.
                  </p>
                  <div className="flex flex-col sm:flex-row items-center sm:items-start w-full mx-auto">
                    <input
                      type="email"
                      placeholder="Enter your email"
                      className="w-full sm:flex-1 px-4 py-2 rounded-md text-[#A8A29E] mb-2 sm:mb-0 sm:mr-2 bg-[#FFFFFF] focus:outline-none"
                    />
                    <button className="w-full sm:w-auto bg-[#A67C52] text-[#FFFFFF] px-5 py-2 rounded-md transition-colors">
                      Subscribe
                    </button>
                  </div>
                </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center text-sm text-[#a1a0a0] gap-6 mt-8 text-center">
              ...
              <div>© 2025 SoundSellers. All rights reserved.</div>
